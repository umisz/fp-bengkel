...
<div class="w3-twothird w3-container">
  <h1 class="page-header"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>  List Pelanggan</h1>
  <div class="w3-container">
    <?php
    foreach($pelanggan as $p){
      ?>
      <div class="list-group w3-col" style="width:80%">
      ...
      <div class="w3-col" style="width:10%">
        <a href="<?php echo base_url('admin/edit_pelanggan/'.$p->id_pelanggan); ?>" class="btn btn-default btn-block">
          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>  Edit
        </a>
      </div>
      <div class="w3-col" style="width:10%">
        <a href="<?php echo base_url('admin/hapus_pelanggan/'.$p->id_pelanggan); ?>" class="btn btn-danger btn-block">
