                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-collapse panel">
                                                <ul class="list-group">
                                                    ...
                                                    <a class="list-group-item active" href="<?php echo base_url('admin/listtransaksi_pelbaru'); ?>"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>  Pelanggan Baru</a>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
