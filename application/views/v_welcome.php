...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="asset/bootstrap/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <i class="glyphicon glyphicon-wrench"></i> <span class="light">Bengkel</span> Dinamo
                </a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h2 class="brand-heading">Bengkel Mustakim</h2>
                        <p class="intro-text">One-stop-solution for your dinamo problem! Handle with care, we will never gonna let you down!</p>
    ...
    <!-- jQuery -->
    <script src="asset/bootstrap/vendor/jquery/jquery.js"></script>
    ...
    <!-- Theme JavaScript -->
    <script src="asset/bootstrap/js/grayscale.min.js"></script>
